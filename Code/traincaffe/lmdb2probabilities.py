...
predictions_out_file = '/storage/hpc_anna/Kaggle_DRD/' + prefix +  'predictions/' + preprocessing_type + '/predictions_prob_' + model_name + '_' + subset + '.txt'
...
with open(predictions_in_file, 'r') as f:
	for i, line in enumerate(f):
		prediction_dict[line.split(' ')[0]] = data[i, :]

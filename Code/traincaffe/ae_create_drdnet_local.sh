...
#
# Usage: ./create_drdnet_local.sh PREFIX PREPROC
# Example: ./create_drdnet_local.sh "" size256
#
...
TRAINTEST_DATA_ROOT=$IMAGES/$PREPROC/traintest
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    $TRAINTEST_DATA_ROOT/ \
    $CAFFEINPUT/$PREPROC/traintest.txt \
    $CAFFEINPUT/$PREPROC/ilsvrc12_traintest_lmdb

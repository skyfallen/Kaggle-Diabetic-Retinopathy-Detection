...
egrep -f /storage/hpc_anna/Kaggle_DRD/sample_images/size256/val_files.txt /storage/hpc_anna/Kaggle_DRD/images/trainCaffeLables.csv > /storage/hpc_anna/Kaggle_DRD/sample_caffeinput/size256/val.txt

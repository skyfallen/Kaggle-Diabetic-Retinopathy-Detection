...
# Create the square toy dataset LMDB inputs
# N.B. set the path to the the train + val data dirs
#
# Usage: ./create_squarenet.sh PREFIX PREPROC
# Example: ./create_squarenet.sh "" size256
#
